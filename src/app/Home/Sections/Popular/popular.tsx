    ...
    <section className="bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-4 py-16 sm:px-6 md:py-20">
      <div className="mx-auto max-w-7xl">
        <Animate variant="fade-up" className="mb-10 text-center">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Popular cities</h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {cities.map((city, i) => (
            <Animate key={city.name} variant="scale-up" delay={i * 60} threshold={0.08}>
              <Link
                href={city.link}
