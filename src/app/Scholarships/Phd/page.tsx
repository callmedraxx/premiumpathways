...
const programs = [
  {
    id: "southwest-university-finance-1",
  ...
  {
    id: "southwest-university-finance-2",
    image: "/img/univ-southwest-finance.jpg",
    university: "Southwest University of Finance and Economics",
    scholarship: "Full Scholarship — Language Program",
    major: "Chinese",
    ...
    <div className="flex flex-col min-h-screen bg-slate-950">
      ...
      <main className="flex flex-1 flex-col">
        ...
        <section className="relative flex h-[420px] items-end justify-center overflow-hidden">
          <Image
            src="/img/phd-hero.jpg"
            alt="PhD Scholarships in China"
            fill
          ...
          <div className="relative z-10 pb-14 text-center px-4">
            ...
            <p className="mx-auto mt-4 max-w-xl text-slate-300">
              Explore fully-funded doctoral opportunities at top Chinese universities — your path to world-class research starts here.
            </p>
          </div>
        </section>
